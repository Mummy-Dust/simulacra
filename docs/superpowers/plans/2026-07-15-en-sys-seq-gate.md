...
- Public repo: NEVER commit absolute local paths, the OS username, real hardware MACs, or real SSIDs. The runner assumes `idf.py` is already on PATH; it must not hardcode IDF install paths.
